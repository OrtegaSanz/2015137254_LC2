...
{
    public class ProvinciaesController : Controller
    {
        private readonly IUnityOfWork unityOfWork;

        public ProvinciaesController(IUnityOfWork UnityOfWork)
        {
            unityOfWork = UnityOfWork;
        }

        public ProvinciaesController()
        {
        ...
        public ActionResult Index()
        {
            ...
            return View(unityOfWork.Provinciaes.GetAll());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Provincia Provincias = unityOfWork.Provinciaes.Get(id.Value);
            if (Provincias == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "ProvinciaId")] Provincia Provincias)
        {
            if (ModelState.IsValid)
            {
                //db.AdministradorEquipos.Add(administradorEquipo);
                unityOfWork.Provinciaes.Add(Provincias);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProvinciaId")] Provincia Provincias)
        {
            if (ModelState.IsValid)
            {
                //db.Entry(administradorEquipo).State = EntityState.Modified;
                unityOfWork.StateModified(Provincias);
                //db.SaveChanges();
                unityOfWork.SaveChanges();
                return RedirectToAction("Index");
            }
        ...
        {
            //AdministradorEquipo administradorEquipo = db.AdministradorEquipos.Find(id);
            Provincia Provincias = unityOfWork.Provinciaes.Get(id);
            unityOfWork.Provinciaes.Delete(Provincias);
            //db.SaveChanges();
            unityOfWork.SaveChanges();
            return RedirectToAction("Index");
        }
